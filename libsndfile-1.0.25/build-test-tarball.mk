...
testprogs += sfversion.exe stdin_test.exe stdout_test.exe cpp_test.exe win32_test.exe
...
files := $(addprefix tests/.libs/,$(subst .exe,$(EXEEXT),$(testprogs))) $(libfiles) $(srcprogs)
