...
/* ./.libs/lt-make_sine.c - temporary wrapper executable for .libs/make_sine.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2

   The make_sine program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "make_sine.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# make_sine - temporary wrapper script for .libs/make_sine.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2\n", f);
  fputs ("#\n", f);
  fputs ("# The make_sine program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"make_sine.exe:make_sine:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"make_sine.exe:make_sine:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"make_sine.exe:make_sine:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
