...
/* ./.libs/lt-sndfilehandle.c - temporary wrapper executable for .libs/sndfilehandle.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2

   The sndfilehandle program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sndfilehandle.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sndfilehandle - temporary wrapper script for .libs/sndfilehandle.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2\n", f);
  fputs ("#\n", f);
  fputs ("# The sndfilehandle program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sndfilehandle.exe:sndfilehandle:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sndfilehandle.exe:sndfilehandle:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sndfilehandle.exe:sndfilehandle:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='sndfilehandle.exe'\n", f);
