...
/* ./.libs/lt-sndfile-to-text.c - temporary wrapper executable for .libs/sndfile-to-text.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2

   The sndfile-to-text program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "sndfile-to-text.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sndfile-to-text - temporary wrapper script for .libs/sndfile-to-text.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2\n", f);
  fputs ("#\n", f);
  fputs ("# The sndfile-to-text program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"sndfile-to-text.exe:sndfile-to-text:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sndfile-to-text.exe:sndfile-to-text:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sndfile-to-text.exe:sndfile-to-text:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='sndfile-to-text.exe'\n", f);
