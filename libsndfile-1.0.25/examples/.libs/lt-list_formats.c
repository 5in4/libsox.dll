...
/* ./.libs/lt-list_formats.c - temporary wrapper executable for .libs/list_formats.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2

   The list_formats program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "list_formats.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# list_formats - temporary wrapper script for .libs/list_formats.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2\n", f);
  fputs ("#\n", f);
  fputs ("# The list_formats program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"list_formats.exe:list_formats:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"list_formats.exe:list_formats:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"list_formats.exe:list_formats:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='list_formats.exe'\n", f);
