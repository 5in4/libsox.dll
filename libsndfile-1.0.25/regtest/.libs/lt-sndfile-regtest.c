...
/* ./.libs/lt-sndfile-regtest.c - temporary wrapper executable for .libs/sndfile-regtest.exe
   Generated by libtool (GNU libtool) 2.4 Debian-2.4-2

   The sndfile-regtest program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\home\\Dominik_2\\libsndfile-1.0.25\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\MinGW\\msys\\1.0\\home\\Dominik_2\\libsndfile-1.0.25\\src\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "sndfile-regtest.exe"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sndfile-regtest - temporary wrapper script for .libs/sndfile-regtest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4 Debian-2.4-2\n", f);
  fputs ("#\n", f);
  fputs ("# The sndfile-regtest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libsndfile.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"sndfile-regtest.exe:sndfile-regtest:${LINENO}: libtool wrapper (GNU libtool) 2.4 Debian-2.4-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sndfile-regtest.exe:sndfile-regtest:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sndfile-regtest.exe:sndfile-regtest:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='sndfile-regtest.exe'\n", f);
  ...
  fputs ("    PATH=/home/Dominik_2/libsndfile-1.0.25/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/Dominik_2/libsndfile-1.0.25/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
