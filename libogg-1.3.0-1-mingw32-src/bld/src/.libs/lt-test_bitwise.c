...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test_bitwise.exe:test_bitwise:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_bitwise.exe:test_bitwise:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_bitwise.exe:test_bitwise:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
